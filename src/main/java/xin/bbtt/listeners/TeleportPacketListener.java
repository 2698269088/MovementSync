...
public class TeleportPacketListener extends SessionAdapter {
    ...
    public synchronized void packetReceived(Session session, Packet packet) {
        ...
        MovementSync.Instance.getLogger().debug("({}, {}, {})", playerPositionPacket.getX(), playerPositionPacket.getY(), playerPositionPacket.getZ());
        ...
        MovementSync.Instance.checkOnGroundMCC();
    }
}